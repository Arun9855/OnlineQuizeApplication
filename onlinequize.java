...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 0) {
            ...
            jb[0].setText("2 Bytes");
            jb[1].setText("3 Bytes");
            jb[2].setText("4 Bytes");
            jb[3].setText("5 Bytes");
        }
        if (current == 1) {
            l.setText("2: What makes java Platform Independent?");
            jb[0].setText("Message Code");
            jb[1].setText("Byte Code");
            jb[2].setText("Machine Code");
            jb[3].setText("Assembly code");
        }
        if (current == 2) {
        ...
        if (current == 7) {
            ...
            jb[0].setText("3 Bytes");
            jb[1].setText("4 Bytes");
            jb[2].setText("8 Bytes");
